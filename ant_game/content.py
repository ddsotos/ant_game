...
def _action(
    ...
    return TraitCard(id=card_id, name=name, root_tags=tags, role=CardRole.ACTION,
                     ...
                     root_tag_counts=root_tag_counts or {})
